        ...
        return (
            <div className="container py-8">
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">User Not Found</h1>
                    ...
                    <div className="card-body p-0">
                        {filteredPicks.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 dark:text-gray-400">No predictions found for this filter.</p>
                            </div>
                        ) : (
                            <div className="divide-y divide-gray-100 dark:divide-gray-700">
                                {filteredPicks.map((pick) => (
                                    <div key={pick.id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                        <div className="flex items-center justify-between">
                                            {/* Left side - Pick info */}
                                            <div className="flex items-center gap-4">
