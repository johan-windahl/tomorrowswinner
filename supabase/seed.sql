...
insert into public.competitions (category, title, slug, start_at, deadline_at, evaluation_start_at, evaluation_end_at)
values (
  'crypto',
  ...
  date_trunc('day', (now() at time zone 'America/New_York') + interval '1 day')::timestamptz,
